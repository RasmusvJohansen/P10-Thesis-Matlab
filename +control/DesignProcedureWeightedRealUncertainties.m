function [param] = DesignProcedureWeightedRealUncertainties(param, info, listOfUncertainties)
...
% uncertainties and their range
    ...
    fprintf("Evaluation of design procedure for weighted real uncertainties \n")
    if(eig(value(Q))<=0)
