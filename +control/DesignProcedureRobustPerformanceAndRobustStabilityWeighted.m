...
constriants = [constriants, DesiredPerformance <= 0,Q_hat>=0,gammaDesiredPerformance >= 0];
...
A_hat_per = [param.model.A, Bw*param.model.Cww, zeros(12,4),zeros(12,4),zeros(12,4);
         zeros(4,12),param.model.Aww, zeros(4),zeros(4),zeros(4);
         param.model.Bwz*Cz, -param.model.Bwz*DWref*param.model.Cww, param.model.Awz, -param.model.Bwz*CWref,zeros(4);
